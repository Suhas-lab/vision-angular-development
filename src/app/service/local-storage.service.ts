...
export class LocalStorageService {
  ...
  public initialiseStorageSyncListener() {
    if (LocalStorageService.syncListenerInitialised == true)
      return;

    LocalStorageService.syncListenerInitialised = true;
  ...
  public clearAllSessionsStorage() {
    ...
    this.clearInstanceSessionStorage();
    localStorage.removeItem(LocalStorageService.DBKEY_SYNC_KEYS);
  ...
  private getSyncKeysFromStorage(defaultValue: string[] = []): string[] {
    ...
    const data = this.localStorageGetItem(LocalStorageService.DBKEY_SYNC_KEYS);
  ...
  private addToSyncKeysBackup(key: string) {
    ...
    if (!storedSyncKeys.some(x => x == key)) {
      ...
      this.localStorageSetItem(LocalStorageService.DBKEY_SYNC_KEYS, storedSyncKeys);
    }
  }
  ...
  public saveSessionData(data: any, key = LocalStorageService.DBKEY_USER_DATA) {
  ...
  public saveSyncedSessionData(data: any, key = LocalStorageService.DBKEY_USER_DATA) {
  ...
  public savePermanentData(data: any, key = LocalStorageService.DBKEY_USER_DATA) {
  ...
  public moveDataToSessionStorage(key = LocalStorageService.DBKEY_USER_DATA) {
  ...
  public moveDataToSyncedSessionStorage(key = LocalStorageService.DBKEY_USER_DATA) {
  ...
  public moveDataToPermanentStorage(key = LocalStorageService.DBKEY_USER_DATA) {
  ...
  public exists(key = LocalStorageService.DBKEY_USER_DATA) {
  ...
  public getData(key = LocalStorageService.DBKEY_USER_DATA) {
  ...
  public getDataObject<T>(key = LocalStorageService.DBKEY_USER_DATA, isDateType = false): T {
  ...
  public deleteData(key = LocalStorageService.DBKEY_USER_DATA) {
